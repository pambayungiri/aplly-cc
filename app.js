...
app.get("/content/v1/tnc", (req, res) => {
  res.status(409).send({
    "data": {
      "errorMessage": "GNR-000-997_errorMessage",
      "errorCode": "GNR-000-997",
      "errorDesc": "DOWNTIME_SERVICE_LEVEL",
      "errorTitle": "GNR-000-997_errorTitle",
      "timestamp": "2025-03-11 15:08:14.019+0700"
    }
  });
});
